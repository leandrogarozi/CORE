...
export function RepeatIcon() {
  return (
    <svg viewBox="0 0 24 24" width="12" height="12" fill="none">
      <path
        d="M4.58301 9.0034C5.14369 7.61566 6.08244 6.41304 7.29255 5.53223C8.50266 4.65141 9.93686 4.12752 11.4298 4.02051C12.9227 3.9135 14.4147 4.2274 15.7381 4.92661C17.0615 5.62582 18.1612 6.68254 18.9141 7.97612M19.4176 14.9971C18.8569 16.3848 17.9181 17.5874 16.708 18.4682C15.4979 19.3491 14.0652 19.8723 12.5723 19.9793C11.0794 20.0863 9.58606 19.7725 8.2627 19.0732C6.93933 18.374 5.83882 17.3175 5.08594 16.0239M10 16H5V21M14 8H19V3"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function WhatsAppIcon({ filled }: { filled?: boolean } = {}) {
  if (filled) {
    return (
      <svg viewBox="0 0 24 24" width="13" height="13" fill="currentColor">
        <path d="M12 2C6.48 2 2 6.13 2 11.22c0 2.19.98 4.19 2.61 5.83-.12 1.5-.5 3.04-1.44 4.24a.6.6 0 00.65.94c1.99-.42 3.65-1.28 4.9-2.25 1.03.28 2.13.44 3.28.44 5.52 0 10-4.13 10-9.2S17.52 2 12 2z" />
      </svg>
    );
  }
  return (
...
export function MenuIcon() {
  return (
    <svg viewBox="0 0 24 24" width="15" height="15" fill="none">
      <path d="M5 17H19M5 12H19M5 7H19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
// Carro do módulo Manutenção. Custom: o pacote não tem veículo nem chave de
// boca (mesma exceção do PillIcon, HashIcon e MicIcon).
export function CarIcon() {
  return (
    <svg viewBox="0 0 24 24" width="14" height="14" fill="none">
      <path
        d="M4.5 11L6 6.6C6.3 5.6 7.2 5 8.2 5h7.6c1 0 1.9.6 2.2 1.6L19.5 11M5 17.5V19M19 17.5V19"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <rect x="3" y="11" width="18" height="6.5" rx="2" stroke="currentColor" strokeWidth="2" />
      <path d="M7 14.2v.01M17 14.2v.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}

// Calendário com marca (Calendar/Calendar_Event do pacote) — a marca de EVENTO:
// compromisso com hora marcada, em oposição a tarefa, que pode andar de dia.
...
// Escudo com alerta (Warning/Shield_Warning do pacote) — a marca de tarefa
// DESAFIADORA: enfrentar + atenção. De propósito diferente da bandeira de
// prioridade e do triângulo de atrasada: prioridade alta é "isso é
// importante"; desafiadora é "disso eu estou fugindo".
export function ShieldWarningIcon({ filled }: { filled?: boolean } = {}) {
  return (
...
export function HashIcon() {
  return (
    <svg viewBox="0 0 24 24" width="14" height="14" fill="none">
      <path
        d="M9 3L7 21M17 3L15 21M3.5 9H21M3 15H20.5"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
// Cartão (Interface/Credit_Card_01 do pacote) — usado na aba de gastos dos checklists.
