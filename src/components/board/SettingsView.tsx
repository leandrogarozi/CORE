...
import { ChevronIcon, TrashIcon, UserIcon } from "./icons";
...
function AvatarUploader({ avatarUrl, board }: { avatarUrl: string | null; board: UseBoard }) {
