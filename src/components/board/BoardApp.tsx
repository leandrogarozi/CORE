...
type ViewMode = "day" | "week" | "dashboard";

function BoardShell() {
  const { board, sortByQuick, setSortByQuick, setSettingsOpen } = useBoardCtx();
  ...
  return (
    <div className="wrap">
      ...
      <div className="section">
        ...
        <div className="hint-text">
          Coisas que costumam ocupar tempo todo dia (almoço, deslocamento, academia...). Aperte o play na hora que
          for fazer, ou marque o dia manualmente pra usar uma duração fixa.
        </div>
